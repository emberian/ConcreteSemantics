...
theory Chapter9_Ex3 imports "~~/src/HOL/IMP/Star" Complex_Main begin
...
Repeat_ty: "\<Gamma> \<turnstile> b \<Longrightarrow> \<Gamma> \<turnstile> c \<Longrightarrow> \<Gamma> \<turnstile> REPEAT c UNTIL b"
